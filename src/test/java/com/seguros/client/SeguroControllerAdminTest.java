...
public class SeguroControllerAdminTest {
    ...
    void testConstructorOriginal() {
        ...
        SeguroControllerAdmin controller = new SeguroControllerAdmin("localhost", "8080");
    ...
    void testListaNombreSegurosCodigo404() throws Exception {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> adminController.listaNombreSeguros());
